...
---Saves the state in the global _G.AvanteCody.state object.
---
---@private
function state:save()
    log.debug("state.save", "saving state globally to _G.AvanteCody.state")

    _G.AvanteCody.state = self
end
...
---Whether the AvanteCody is enabled or not.
---
